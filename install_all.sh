...
#установка AMD
MINER_LINK_=https://github.com/tontechio/pow-miner-gpu/releases/download/20211116-1/minertools-opencl-ubuntu-18.04-x86-64.tar.gz
mkdir miner0 && echo "miner 0 directory created"
echo "downloading miner archive from  $MINER_LINK_"
wget -O miner_archive.tar.gz $MINER_LINK_ && echo "miner archive downloaded"
echo "unpacking miner achive"
...
deploy_miner_dirs.sh $GIVER_ADDRESS_ $USER_WALLET_ $GPU_COUNT_ $DEVELOPER_WALLET_ $BOOST_FACTOR_ $GPU_TYPE_
